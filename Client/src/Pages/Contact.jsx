...
const Contact = () => {
  ...
  return (
    <div
      ...
      className="h-screen flex bg-gradient-to-t from-violet-800 gap-80 justify-start  bg-gray-50"
    >
      <div className="m-5">
        <button
          onClick={() => {
          ...
          type="button"
          class="bg-white text-center w-44 rounded-2xl h-12 relative font-sans text-black text-xl font-semibold group"
        >
          <div class="bg-green-400 rounded-xl h-10 w-1/4 flex items-center justify-center absolute left-1 top-[4px] group-hover:w-[165px] z-10 duration-500">
            <svg
              width="25px"
              height="25px"
