...
const Contact = () => {
  ...
  return (
    <div
      ...
      className="h-screen flex bg-gradient-to-tr from-black gap-80 justify-start  bg-gray-50"
    >
      <div className="m-5">
        <button
          onClick={() => {
          ...
          type="button"
          className="bg-white text-center w-44 rounded-2xl h-12 relative font-sans text-black text-xl font-semibold group"
        >
          <div className="bg-green-400 rounded-xl h-10 w-1/4 flex items-center justify-center absolute left-1 top-[4px] group-hover:w-[165px] z-10 duration-500">
            <svg
              width="25px"
              height="25px"
      ...
      <div>
        <div className="text-center text-4xl font-bold text-rose-900 mt-10">
          About Me!
        </div>
        <div className="flex flex-col items-center justify-between gap-5 p-3 bg-transparent border rounded-lg m-2 border-blue-500 hover:shadow-xl hover:shadow-gray-400 transition-all hover:border-gray-600 hover:border-3 backdrop-blur-3xl w-[450px] h-[600px] shadow-lg">
          <div className="flex gap-5">
            <div className="rounded-full w-[150px] h-[150px] border border-blue-400 overflow-hidden mt-6">
              <img
                className="w-[180px] relative bottom-3"
                src="/satyam.png"
                alt="Developer"
              />
            </div>
            <div className="flex flex-col justify-center items-center">
              <div className="text-gray-900 font-bold text-2xl mt-4">
                SATYAM UPADHYAY
              </div>
              <div className="text-gray-700 font-semibold text-xl mb-6">
          ...
          <div>
            ...
            >
              ...
              <p className="z-10">MY PORTFOLIO</p>
            </a>
          </div>
          <div className="flex flex-col gap-5 items-center">
            <div className="flex gap-5 items-center">
              ...
              <div>
                <section className="flex justify-center items-center">
                  <a
                    href="https://www.instagram.com/_satyam_915/"
